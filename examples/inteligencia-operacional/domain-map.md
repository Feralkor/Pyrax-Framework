# Reference Pattern — Inteligência Operacional
...
Warehouse-specific FIFO/FEFO, depositor, lot, picking and buffer semantics belong to the operational-intelligence domain and must not be generalized into the framework core.
